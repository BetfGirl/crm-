		...
		layui.use('table', function() {
			...
			table.on('tool(test)', function(obj) {
				...
				if (obj.event === 'del') { ///lay-event 属性
					...
					myconfirm("刪除？",function(){
						$.post("../ClientType/delete.action", {cmd : "delete",id : data.id}, 
								function(json) {
							reload('demo');
					...
					//对应MY.js里面opopenFrametype函数
					openFrametype('../ClientType/edit.jsp?id='+data.id);
				}
			});
			...
			table.on('toolbar(test)', function(obj) {
				if (obj.event === 'search') {
					...
					openFrametype("../ClientType/edit.jsp");
				}
			});
